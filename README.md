...
##before executing change the name of 2015-04-30.txt to 2015-04-30.json,and run the data2spreadsheet.py file on it, this is the ##sample file I have stored the tweets in. It will then be converted into a spreadsheet.
